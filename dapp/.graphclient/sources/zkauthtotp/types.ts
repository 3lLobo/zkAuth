...
export namespace ZkauthtotpTypes {
  ...
  export type QuerySdk = {
    /** null **/
    authentication: InContextSdkMethod<
      Query['authentication'],
      QueryauthenticationArgs,
      MeshContext
    >
    /** null **/
    authentications: InContextSdkMethod<
      Query['authentications'],
      QueryauthenticationsArgs,
      MeshContext
    >
    /** null **/
    authData: InContextSdkMethod<
      Query['authData'],
      QueryauthDataArgs,
      MeshContext
    >
    /** null **/
    authDatas: InContextSdkMethod<
      Query['authDatas'],
      QueryauthDatasArgs,
      MeshContext
    >
    /** null **/
    authStatus: InContextSdkMethod<
      Query['authStatus'],
      QueryauthStatusArgs,
      MeshContext
    >
    /** null **/
    authStatuses: InContextSdkMethod<
      Query['authStatuses'],
      QueryauthStatusesArgs,
      MeshContext
    >
    /** null **/
    address: InContextSdkMethod<Query['address'], QueryaddressArgs, MeshContext>
    /** null **/
    addresses: InContextSdkMethod<
      Query['addresses'],
      QueryaddressesArgs,
      MeshContext
    >
  ...
  export type SubscriptionSdk = {
    ...
    authentication: InContextSdkMethod<
      ...
      SubscriptionauthenticationArgs,
      MeshContext
    >
    /** null **/
    authentications: InContextSdkMethod<
      Subscription['authentications'],
    ...
    authData: InContextSdkMethod<
      ...
      SubscriptionauthDataArgs,
      MeshContext
    >
    /** null **/
    authDatas: InContextSdkMethod<
      Subscription['authDatas'],
      SubscriptionauthDatasArgs,
      MeshContext
    >
    /** null **/
    authStatus: InContextSdkMethod<
      Subscription['authStatus'],
      SubscriptionauthStatusArgs,
      MeshContext
    >
    /** null **/
    authStatuses: InContextSdkMethod<
      Subscription['authStatuses'],
      SubscriptionauthStatusesArgs,
      MeshContext
    >
    /** null **/
    address: InContextSdkMethod<
      Subscription['address'],
      SubscriptionaddressArgs,
      MeshContext
    >
    /** null **/
    addresses: InContextSdkMethod<
      Subscription['addresses'],
      SubscriptionaddressesArgs,
      MeshContext
    >
    /** Access to subgraph metadata **/
