...
} from "../../contracts/TotpAuthenticator";
...
type TotpAuthenticatorConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TotpAuthenticatorConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TotpAuthenticator__factory extends ContractFactory {
  constructor(...args: TotpAuthenticatorConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<TotpAuthenticator>;
  }
  ...
  override attach(address: string): TotpAuthenticator {
    return super.attach(address) as TotpAuthenticator;
  }
  override connect(signer: Signer): TotpAuthenticator__factory {
    return super.connect(signer) as TotpAuthenticator__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TotpAuthenticatorInterface {
    return new utils.Interface(_abi) as TotpAuthenticatorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TotpAuthenticator {
    return new Contract(address, _abi, signerOrProvider) as TotpAuthenticator;
  }
}
