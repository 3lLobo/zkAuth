...
export interface OtpMerkleTreeVerifierInterface extends utils.Interface {
  functions: {
...
export interface OtpMerkleTreeVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OtpMerkleTreeVerifierInterface;
