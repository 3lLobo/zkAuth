...
export interface IOtpMerkleTreeVerifierInterface extends utils.Interface {
  functions: {
...
export interface IOtpMerkleTreeVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOtpMerkleTreeVerifierInterface;
